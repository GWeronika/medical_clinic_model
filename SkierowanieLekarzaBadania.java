...
public class SkierowanieLekarzaBadania extends JFrame implements BazaDanychConnect {
    public SkierowanieLekarzaBadania(int idLekarza) {
        super("Panel lekarza");
        ...
        button.addActionListener(e -> {
            TworzenieSkierowaniaBadania noweSkierowanieFrame = new TworzenieSkierowaniaBadania(idLekarza);
        ...
        String[] columnNames = {"Imie", "Nazwisko", "Data urodzenia", "PESEL", "Płeć", "nr Telefonu", "Cel skierowania"};
        ...
        try {
            String query = "SELECT pacjent.imie, pacjent.nazwisko, data_urodzenia, pesel, plec, nrTelefonu, skierowaniebadanie.nazwa_badania AS celSkierowania " +
                    "FROM pacjent JOIN skierowaniebadanie ON skierowaniebadanie.idPacjenta = pacjent.id JOIN pracownik ON skierowaniebadanie.idLekarza = pracownik.id " +
                    "WHERE pracownik.id = " + idLekarza;
            ...
            while (resultSet.next()) {
                ...
                String spec = resultSet.getString("celSkierowania");
        ...
        table.getColumnModel().getColumn(6).setPreferredWidth(150);         //cel skierowania
